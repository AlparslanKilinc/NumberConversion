	   	.data
Selection: 	.asciiz "Make a Selection from 1-4 \n"
Choices:   	.asciiz "1.) Binary to hexadecimal and decimal \n2.) Hexadecimal to Binary and decimal \n3.) Decimal to Binary and hexadecimal \n4.) Exit"
Enter:     	.asciiz "Enter a Number To Convert"
userInput: 	.space 32
